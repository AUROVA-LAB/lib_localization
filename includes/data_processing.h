...
public:
	...
	PointCloudPCL getAssociatedLmPcl (void){
		return associated_lm_pcl_;
	}
	PointCloudPCL getAssociatedDtPcl (void){
		return associated_dt_pcl_;
	}
...
private:
	...
	PointCloudPCL associated_dt_pcl_;
	PointCloudPCL associated_lm_pcl_;
